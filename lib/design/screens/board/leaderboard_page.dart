...
import 'package:flutter_steps_tracker/design/cubits/leaderboard/leaderboard_cubit.dart';
import 'package:flutter_steps_tracker/design/cubits/leaderboard/leaderboard_state.dart';
import 'package:flutter_steps_tracker/design/screens/board/widgets/leaderboard_item.dart';
import 'package:flutter_steps_tracker/design/screens/board/widgets/leaderboard_top_item.dart';
            ...
            child: BlocBuilder<LeaderboardCubit, LeaderboardState>(
              ...
              builder: (context, state) {
                return state.maybeWhen(
                  loading: () =>
                      _buildLeaderboardPage(context, isLoading: true),
                  loaded: (users) =>
                      _buildLeaderboardPage(context, users: users),
